...
class BasicCommands(commands.Cog):
    ...
    async def rules(self, ctx):
        embed=disnake.Embed(title="Rules", color=0x37e154)
        ...
        embed.add_field(name="Rule 8:", value="Do not post links or invites in the wrong channels. (Not #💬disnake-server-invites)", inline=False)
